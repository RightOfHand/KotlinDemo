...
import app.songy.com.global_base.component.imageClip.ClipImageActivity;

/**
 *Description:
 *creator: song
 *Date: 2018/6/11 下午5:27
 */
public class CaptureCropUtil {
    ...
    private void startCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(mActivity, "app.songy.com.kotlindemo.fileProvider", getTempCaptureImageFile());
    ...
    public void resizeImage(Uri uri, int aspectX, int aspectY, int outputX, int outputY) {
        ...
        Logs.defaults.e("aspectX" + aspectX + " aspectY" + aspectY + " outputX" + outputX + " outputY" + outputY);
    }
